...
public class QuestionInfoResponseDto {
    ...
    private String selectedAnswerAuthorName;
    private boolean autoSelected;

    public QuestionInfoResponseDto(Question q, String authorName, String selectedAnswerAuthorName) {
        this.id = q.getId();
        ...
        this.selectedAnswerAuthorName = selectedAnswerAuthorName;
